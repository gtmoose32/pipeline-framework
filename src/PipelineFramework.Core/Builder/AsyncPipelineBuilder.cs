...
namespace PipelineFramework.Builder
{
    ...
    internal class AsyncPipelineBuilder<TPayload> :
        ...
        IPipelineBuilder<IAsyncPipeline<TPayload>>
    {
        ...
        public IAdditionalPipelineComponentHolder<IAsyncPipeline<TPayload>, IAsyncPipelineComponent<TPayload>, TPayload> WithComponent<TComponent>()
        ...
        public IAdditionalPipelineComponentHolder<IAsyncPipeline<TPayload>, IAsyncPipelineComponent<TPayload>, TPayload> WithComponent(string componentName)
        {
